      ...
      return `<tr data-id="${l.id}" style="border-left:3px solid ${bordaFinal};background:${rbgFinal}">
        ...
        <td style="text-align:right">
          <div class="loc-acts" style="justify-content:flex-end">
            ...
            ${l.status === "aguardando_assinatura" ? `
            ${l.assinadoEm ? `
      ...
      cardsEl.innerHTML = slice.map(l => {
        ...
        const acoes = `
          ...
          ${l.status === "aguardando_assinatura" ? (l.assinadoEm
            ...
            : `<button class="lac" onclick="assinarManualAdmin('${l.id}')" style="background:#fefce8;color:#92400e;border-color:#fde68a"><i class="ti ti-pen" style="font-size:12px"></i><span>Assinar</span></button>`) : ""}
